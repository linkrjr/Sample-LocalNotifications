...
SWIFT_CLASS("_TtC25Sample_LocalNotifications11AppDelegate")
...
SWIFT_CLASS("_TtC25Sample_LocalNotifications14ViewController")
@interface ViewController : UIViewController <UITableViewDataSource>
- (void)viewDidLoad;
- (void)addNotification:(id __nonnull)sender;
